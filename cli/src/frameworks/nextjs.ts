...
export async function setupNextJS(projectRoot: string, options: NextJSSetupOptions) {
...
async function detectNextJSStructure(projectRoot: string) {
...
async function createEnvironmentFile(projectRoot: string) {
...
async function createApiRoute(projectRoot: string, isAppRouter: boolean, srcDir: boolean) {
...
async function createExampleComponents(projectRoot: string, srcDir: boolean) {
    const baseDir = srcDir ? 'src' : '';
...
async function createExamplePages(projectRoot: string, isAppRouter: boolean, srcDir: boolean) {
    const baseDir = srcDir ? 'src' : '';
...
function showCompletionMessage(projectRoot: string, options: NextJSSetupOptions) {
